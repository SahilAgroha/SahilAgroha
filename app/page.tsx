...
const EMAIL = "sahil.sheoran.agroha@gmail.com";
...
const projects: Project[] = [
  {
    num: "01",
    name: {
      es: "NexBank – Digital Banking Platform",
      en: "NexBank – Digital Banking Platform",
    },
    stack: [
      "Spring Boot",
      "React",
    ...
    desc: {
      es: "Modular monolithic banking platform with ACID-compliant transactions, idempotent fund transfers and Kafka-driven async notifications.",
      en: "Modular monolithic banking platform with ACID-compliant transactions, idempotent fund transfers and Kafka-driven async notifications.",
    },
    details: {
      es: "Architected a modular monolithic banking platform with Account, Transaction, Payment, Beneficiary, Notification, Fraud, Admin, and Audit modules, using clean domain boundaries and ACID-compliant transactional workflows. Secured financial operations with JWT + RBAC, idempotent fund transfers, optimistic locking, and audit logging; designed concurrent transaction handling to prevent duplicate payments and inconsistent account balances. Improved system reliability and scalability using Kafka for asynchronous notifications, audit, fraud, and analytics events; containerized the application with Docker and exposed REST APIs through Swagger/OpenAPI.",
      en: "Architected a modular monolithic banking platform with Account, Transaction, Payment, Beneficiary, Notification, Fraud, Admin, and Audit modules, using clean domain boundaries and ACID-compliant transactional workflows. Secured financial operations with JWT + RBAC, idempotent fund transfers, optimistic locking, and audit logging; designed concurrent transaction handling to prevent duplicate payments and inconsistent account balances. Improved system reliability and scalability using Kafka for asynchronous notifications, audit, fraud, and analytics events; containerized the application with Docker and exposed REST APIs through Swagger/OpenAPI.",
    },
    github: "https://github.com/SahilAgroha/NexBank",
    url: "https://nexbank-platform.vercel.app",
    highlights: ["react", "docker", "postgresql"],
    align: "left",
    section: "project1",
  },
  {
    num: "02",
    name: {
      es: "E-Baazar – Scalable E-Commerce",
      en: "E-Baazar – Scalable E-Commerce",
    },
    stack: [
      "Spring Boot",
      "PostgreSQL",
    ...
    desc: {
      es: "Multi-tenant RBAC e-commerce platform with Strategy & Factory design patterns, distributed caching and sub-3s Razorpay checkout.",
      en: "Multi-tenant RBAC e-commerce platform with Strategy & Factory design patterns, distributed caching and sub-3s Razorpay checkout.",
    },
    details: {
      es: "Engineered multi-tenant RBAC backend (Admin, Seller, Customer) applying Strategy and Factory design patterns; enforced strict cross-tenant data isolation across 100% of API endpoints. Boosted API response time by 40% combining distributed cache + composite DB indexes; sub-3-second Razorpay checkout; React.js on Vercel + Spring Boot on Render with GitHub Actions CI/CD pipeline.",
      en: "Engineered multi-tenant RBAC backend (Admin, Seller, Customer) applying Strategy and Factory design patterns; enforced strict cross-tenant data isolation across 100% of API endpoints. Boosted API response time by 40% combining distributed cache + composite DB indexes; sub-3-second Razorpay checkout; React.js on Vercel + Spring Boot on Render with GitHub Actions CI/CD pipeline.",
    },
    github: "https://github.com/SahilAgroha/E-Bazaar",
    url: "https://ebazaar-platform.vercel.app",
    highlights: ["react", "docker", "postgresql", "typescript"],
    align: "right",
    section: "project2",
  },
  {
    num: "03",
    name: {
      es: "NexaMed – AI Healthcare Platform",
      en: "NexaMed – AI Healthcare Platform",
    },
    stack: [
      "Spring Boot",
      "Spring Cloud",
    ...
    desc: {
      es: "9-microservice AI healthcare & learning platform with event-driven architecture, JWT+RBAC security and OpenAI-powered quiz generation.",
      en: "9-microservice AI healthcare & learning platform with event-driven architecture, JWT+RBAC security and OpenAI-powered quiz generation.",
    },
    details: {
      es: "Architected 9 independently deployable microservices (Auth, API Gateway, Course, Notification, AI Service) using Domain-Driven Design; Spring Cloud Config + Eureka for service discovery and fault-tolerant resilience. Slashed notification latency by 20% by replacing synchronous REST calls with Apache Kafka event-driven messaging; processes 1,000+ concurrent events without blocking primary request threads. Eliminated 90% of unauthorized access via JWT + RBAC; accelerated read endpoints by 40% with cache-aside TTL strategy; integrated OpenAI API shrinking quiz creation from 10 min to 2 sec.",
      en: "Architected 9 independently deployable microservices (Auth, API Gateway, Course, Notification, AI Service) using Domain-Driven Design; Spring Cloud Config + Eureka for service discovery and fault-tolerant resilience. Slashed notification latency by 20% by replacing synchronous REST calls with Apache Kafka event-driven messaging; processes 1,000+ concurrent events without blocking primary request threads. Eliminated 90% of unauthorized access via JWT + RBAC; accelerated read endpoints by 40% with cache-aside TTL strategy; integrated OpenAI API shrinking quiz creation from 10 min to 2 sec.",
    },
    github: "https://github.com/SahilAgroha/NexaMed",
    highlights: ["typescript", "docker", "postgresql"],
    align: "left",
    section: "project3",
  },
  {
    num: "04",
    name: {
      es: "Hiredly – AI-Powered Job Portal",
      en: "Hiredly – AI-Powered Job Portal",
    },
    stack: [
      "Spring Boot",
      "MySQL",
    ...
    desc: {
      es: "Multi-tenant job portal with Gemini AI interview assessment, 35% DB latency reduction via composite indexes and cursor-based pagination.",
      en: "Multi-tenant job portal with Gemini AI interview assessment, 35% DB latency reduction via composite indexes and cursor-based pagination.",
    },
    details: {
      es: "Optimized database latency by 35% applying composite MySQL indexes, cursor-based pagination, and query rewrites across 10+ high-traffic job listing and candidate search endpoints. Halved manual HR screening effort via Gemini API AI-driven interview assessment with real-time scoring; reduced error response time by 45% through async email queuing and centralized exception handling.",
      en: "Optimized database latency by 35% applying composite MySQL indexes, cursor-based pagination, and query rewrites across 10+ high-traffic job listing and candidate search endpoints. Halved manual HR screening effort via Gemini API AI-driven interview assessment with real-time scoring; reduced error response time by 45% through async email queuing and centralized exception handling.",
    },
    github: "https://github.com/SahilAgroha/Hiredly",
    highlights: ["react", "typescript", "docker"],
    align: "right",
    section: "project4",
  },
];
...
const experiences: Array<{
  ...
  {
    role: { es: "Full-Stack Development Intern", en: "Full-Stack Development Intern" },
    company: "KT20",
    period: { es: "Apr 2026 — Jul 2026", en: "Apr 2026 — Jul 2026" },
    location: { es: "Canada (Remote)", en: "Canada (Remote)" },
    summary: {
      es: "Developed and optimized scalable Java Spring Boot + React applications for 10,000+ active users, building secure REST APIs and improving performance through efficient API design and database optimization.",
      en: "Developed and optimized scalable Java Spring Boot + React applications for 10,000+ active users, building secure REST APIs and improving performance through efficient API design and database optimization.",
    },
    bullets: [
      {
        es: "Built secure REST APIs with Spring Boot serving 10,000+ active users, focusing on efficient API design and database optimization.",
        en: "Built secure REST APIs with Spring Boot serving 10,000+ active users, focusing on efficient API design and database optimization.",
      },
      {
        es: "Collaborated in an Agile environment using Git and code reviews, debugging production issues and delivering reliable features with faster release cycles.",
        en: "Collaborated in an Agile environment using Git and code reviews, debugging production issues and delivering reliable features with faster release cycles.",
      },
    ],
    stack: ["Java", "Spring Boot", "React", "REST APIs", "PostgreSQL", "Git"],
  },
];
      ...
      <div className="relative">
        ...
        <header className="fixed top-0 inset-x-0 z-50 px-6 sm:px-10 md:px-14 py-5 flex items-center justify-between pointer-events-none">
          ...
          <div className="flex items-center gap-2 pointer-events-auto">
            ...
            <span className="hidden md:inline-flex">
            <a
              href="https://github.com/SahilAgroha"
              target="_blank"
