...
export const metadata: Metadata = {
  title: "Sahil Sheoran — Backend-focused Full-Stack Engineer",
  description:
    "Portfolio of Sahil Sheoran — Backend-focused Full-Stack Engineer. Java, Spring Boot, Kafka, React. IIIT Bhopal '27.",
  authors: [{ name: "Sahil Sheoran" }],
  openGraph: {
    title: "Sahil Sheoran — Backend-focused Full-Stack Engineer",
    description:
      "Immersive 3D portfolio. Java, Spring Boot, Kafka, React, microservices, IIIT Bhopal.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
